...
class Render(object):
    ...
    def render(self):
        start_room = self.Level.level[0][0].neighbours
                ...
                if start_room[i] == 1:
                    ...
                    if i == 0:
                        pygame.draw.rect(self.game_window, (222, 23, 23),
                                         (TILE_SIZE * coordinates[0] + TILE_SIZE / 2, TILE_SIZE * coordinates[1],
                                          TILE_SIZE / 10, TILE_SIZE / 10))
                    elif i == 1:
                        pygame.draw.rect(self.game_window, (222, 23, 23),
                                         (TILE_SIZE * coordinates[0], TILE_SIZE * coordinates[1] + TILE_SIZE * .5,
                                          TILE_SIZE / 10, TILE_SIZE / 10))
                    elif i == 2:
                        pygame.draw.rect(self.game_window, (222, 23, 23),
                                         (TILE_SIZE * coordinates[0] + TILE_SIZE / 2, TILE_SIZE * coordinates[1],
