    ...
    def create_sprite(self, posx, posy, size):
        ...
        for x in range(0, size):
            for y in range(0, size):
                pixels[x + y * size] = (self.sprite_sheet_image_array[x + posx][y + posy] & 0x0000FF) << 16 | (self.sprite_sheet_image_array[x + posx][y + posy] & 0x00FF00) | (self.sprite_sheet_image_array[x + posx][y + posy] & 0xFF0000) >> 16
        return pixels
